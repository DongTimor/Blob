...
class Flex_home : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_flex_home)

        lateinit var binding: ActivityFlexHomeBinding
        binding = ActivityFlexHomeBinding.inflate(layoutInflater)
        ...
        binding.flexplay.setOnClickListener{
                    mainsound.stop()
        var intent = Intent(this,ColorChooseMainActivity::class.java )
        ...
        binding.flexcustom.setOnClickListener{
            ...
            binding.customplustime.isVisible = false
                ...
                binding.flexcustom.isEnabled = false
                binding.flexplay.isEnabled = false
                binding.backpick2.isEnabled = false
        ...
        binding.timeboardok.setOnClickListener {
            ...
            if(Integer.parseInt(binding.edittime.text.toString()) > 120 || Integer.parseInt(binding.edittime.text.toString()) < 0){
                ...
                time1 = Integer.parseInt(binding.edittime.text.toString())
        ...
        binding.customboartok.setOnClickListener {
            ...
            time1 = Integer.parseInt(binding.customboardtime.text.toString())
            binding.flexcustom.isEnabled = true
            binding.flexplay.isEnabled = true
            binding.backpick2.isEnabled = true
        }
