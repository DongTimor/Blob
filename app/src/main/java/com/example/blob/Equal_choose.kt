...
import com.example.blob.databinding.ActivityEqualChooseBinding
import com.example.blob.databinding.ActivityFlexHomeBinding
...
class Equal_choose : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_flex_home)

        lateinit var binding: ActivityEqualChooseBinding
        binding = ActivityEqualChooseBinding.inflate(layoutInflater)
        setContentView(binding.root)

        binding.edittime.setText(binding.customboardtime.text)




        binding.equalPlay.setOnClickListener{
            mainsound.stop()
        ...
        binding.equalcustom3.setOnClickListener{
            ...
            binding.CustomBoard.isVisible = true
            binding.equalcustom3.isEnabled = false
            binding.equalPlay.isEnabled = false
            binding.backpick5.isEnabled = false
        ...
        binding.customsubtractiontime.setOnLongClickListener(object : View.OnLongClickListener {
            override fun onLongClick(view: View?): Boolean {
                ...
                setViewAndChildrenEnabled(binding.CustomBoard,false)
                return true
            }
        })
        ...
        binding.customboartok.setOnClickListener {
            binding.CustomBoard.isVisible = false
            time3 = Integer.parseInt(binding.customboardtime.text.toString())
            binding.equalcustom3.isEnabled = true
            binding.equalPlay.isEnabled = true
            binding.backpick5.isEnabled = true
        }
